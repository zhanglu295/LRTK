...
if __name__ == '__main__':
	...
	for ch in rChrlist:
		...
		shell_line = " ".join(["set -e\n", javapath, "-Djava.io.tmpdir=" + vcfdir, "-jar", gatkpath, "-T HaplotypeCaller -R", ref, "-I", inputbam, "-U --emitRefConfidence GVCF", HaplotypeCaller_par, "--dbsnp", dbsnp, "-L", ch, "-o", chrgvcf, "\n"])
